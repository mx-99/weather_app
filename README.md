This repository is a deployment of the weather app  from The Odin Project. It contains the dist folder that was built and bundled using Webpack and is deployed to GitHub Pages .
